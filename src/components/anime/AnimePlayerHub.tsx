...
const SOURCES: {
  ...
  },
  {
    id: 'anfire',
    label: 'AnFire',
    description: 'AnimeFire через адаптер AnFireAPI',
    icon: Flame,
  },
]
      ...
      <div className="p-4 sm:p-5">
        <div className="mb-4 flex items-center gap-2 rounded-2xl border border-border/30 bg-background/35 px-3 py-2 text-xs text-muted-foreground">
          ...
          <span className="min-w-0">
            Сейчас выбран {activeMeta.label}. Источники работают по-разному, поэтому запасной плеер здесь реально полезен.
          </span>
        </div>
