        ...
        <div className="container mx-auto max-w-3xl">
          ...
          <Tabs defaultValue="friends" className="space-y-6">
            <TabsList className="bg-input border h-12 overflow-x-auto w-full">
              <TabsTrigger value="friends" className="data-[state=active]:bg-primary data-[state=active]:text-foreground shrink-0">
                Друзья ({friends.length})
              </TabsTrigger>
              <TabsTrigger value="requests" className="data-[state=active]:bg-primary data-[state=active]:text-foreground shrink-0">
                Заявки ({pendingRequests.length})
              </TabsTrigger>
              <TabsTrigger value="search" className="data-[state=active]:bg-primary data-[state=active]:text-foreground shrink-0">
                Поиск
              </TabsTrigger>
            </TabsList>
